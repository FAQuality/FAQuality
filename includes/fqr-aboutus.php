...
?>
    <div class="wrap">
        <div class="content">
            ...
            <h2>¿Quiénes somos?</h2>
            <div>
                <p>Somos dos estudiantes con ganas de aprender y, modestia aparte, increíblemente guapos (o eso nos decimos para motivarnos, ¡y no nos va nada mal!). Este plugin es el resultado de muchas horas de trabajo, esfuerzo y aprendizaje. Aunque empezó como un proyecto personal para poner a prueba nuestras habilidades, con el tiempo se ha convertido en una herramienta sólida y funcional, lista para ser utilizada por otros.</p>
                <p>A lo largo de su desarrollo, hemos enfrentado muchos desafíos y superado obstáculos, pero cada paso nos ha permitido mejorar tanto el código como la experiencia del usuario. Este plugin no solo es el reflejo de lo que hemos aprendido, sino también de nuestra evolución como programadores. Hemos incorporado cada nueva función con la intención de hacer de este plugin una solución más completa y eficiente, adaptada a las necesidades de quienes lo usen.</p>
